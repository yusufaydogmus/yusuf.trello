...
namespace yusuf.trello.Migrations
{
    ...
    [Migration("20231001214113_addingPositionPropertyToCard")]
    partial class addingPositionPropertyToCard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("yusuf.trello.Boards.Board", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("yusuf.trello.Cards.Card", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppCards", (string)null);
                });

            modelBuilder.Entity("yusuf.trello.Lists.Liste", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppLists", (string)null);
                });
            ...
            modelBuilder.Entity("yusuf.trello.Cards.Card", b =>
                {
                    b.HasOne("yusuf.trello.Lists.Liste", "Liste")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("yusuf.trello.Lists.Liste", b =>
                {
                    b.HasOne("yusuf.trello.Boards.Board", "Board")
                        .WithMany("Listes")
